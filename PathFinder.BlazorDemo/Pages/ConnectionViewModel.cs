...
public class ConnectionViewModel : PolylineViewModel
{
    ...
    public ConnectionViewModel(HierachicalMap map, ConnectionPointViewModel startPoint,
        ConnectionPointViewModel endPoint) : base(PolyLine.Create(startPoint.Primitive.BoundingRectangle.Center,
